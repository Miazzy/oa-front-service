...
// CONCATENATED MODULE: ./lib/EleForm.vue?vue&type=template&id=09510f4b&
...
/* harmony default export */ var EleFormvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    // 是否显示模拟数按钮
    isShowMockBtn: function isShowMockBtn() {
      var _this = this;

      return !utils.isProd() && (this.mock || this.formDescKeys.some(function (field) {
        return _this.formDesc[field].mock;
      }));
    },
    // 按钮
    btns: function btns() {
    ...
    computedRules: function computedRules() {
      ...
      return this.formDescKeys.reduce(function (rules, field) {
        ...
        var formItemRules = _this2.formDesc[field].rules; // 转为数组
        ...
        if (_this2.formDesc[field].required && !rules[field].some(function (rule) {
          return rule.required;
        })) {
          rules[field].push({
            required: true,
            message: _this2.formDesc[field].label + locale_t('ele-form.required')
          });
        }
      ...
      handler: function handler(desc) {
        ...
        if (desc) {
          Object.keys(desc).forEach(function (field) {
            // 设置 options
            _this3.changeOptions(desc[field].options, desc[field].prop, field); // 设置 mock 状态


            if (!utils.isProd() && _this3.mock && utils.isUnDef(desc[field].mock)) {
  ...
  methods: {
        ...
        this.checkLinkageFn = throttle(300, function () {
          ...
          Object.keys(formDesc).forEach(function (field) {
            ...
            if (typeof formItem.type === 'function') {
              type = _this5.getComponentName(formItem.type(formData));

              if (formItem._type && formItem._type !== type) {
                // 类型改变, 则删除原数据
                _this5.formData[field] = null;
              }
            } else {
              type = _this5.getComponentName(formItem.type);
            } // 1.触发 v-if 显示 / 隐藏
            ...
            Object.defineProperties(formItem, {
              '_type': _this5.defineLinkageProperty(type),
              '_vif': _this5.defineLinkageProperty(vif),
              '_vshow': _this5.defineLinkageProperty(vshow),
              '_disabled': _this5.defineLinkageProperty(disabled)
            }); // 4.重新获取 options

            if (formItem._vif && formItem.isReloadOptions && typeof formItem.options === 'function') {
              _this5.changeOptions(formItem.options, formItem.prop, field, true);
            }
          });
        });
        this.checkLinkageFn();
      ...
      if (options) {
        if (options instanceof Array) {
          ...
          options.then(function (options) {
            _this6.changeOptions(options, prop, field, resetValue);
          });
    ...
    validateForm: function validateForm() {
      ...
      return new Promise(function (resolve, reject) {
        if (_this7.computedRules) {
          // 当传递了验证规则
          _this7.$refs['form'].validate(function (valid, invalidFields) {
            if (valid) {
              // 验证通过
              resolve();
            } else {
    ...
    validateComponent: function validateComponent() {
      ...
      var validators = this.formDescKeys.map(function (key) {
        return _this8.$refs[key] && _this8.$refs[key][0] ? _this8.$refs[key][0].validate : null;
      }).filter(Boolean);
    ...
    processError: function processError(errObj) {
      ...
      try {
        var messageArr = Object.keys(errObj).reduce(function (acc, key) {
          var formItem = _this9.formDesc[key];
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 14:
                ...
                this.$nextTick(function () {
                  _this10.$emit('request-success', response);
                });
                _context.next = 22;
                break;
    ...
    resetForm: function resetForm() {
      ...
      this.$refs.form.fields.forEach(function (field) {
        _this11.formData[field.prop] = field.initialValue;
      });
    }
  },
  mounted: function mounted() {
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"de756198-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./lib/components/EleFormTag.vue?vue&type=template&id=300f5cd1&
var EleFormTagvue_type_template_id_300f5cd1_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-select',_vm._g(_vm._b({ref:"select-tag",staticClass:"ele-form-full-line",class:_vm.desc.class,style:(_vm.desc.style),attrs:{"allow-create":"","default-first-option":"","filterable":"","multiple":""},model:{value:(_vm.newValue),callback:function ($$v) {_vm.newValue=$$v},expression:"newValue"}},'el-select',_vm.attrs,false),_vm.onEvents),_vm._l((_vm.options),function(tag){return _c('el-option',{key:tag.value,attrs:{"label":tag.value,"value":tag.value}})}),1)}
var EleFormTagvue_type_template_id_300f5cd1_staticRenderFns = []


// CONCATENATED MODULE: ./lib/components/EleFormTag.vue?vue&type=template&id=300f5cd1&
...
/* harmony default export */ var EleFormTagvue_type_script_lang_js_ = ({
  ...
  methods: {
    handleOptionSelect: function handleOptionSelect(option, byClick) {
      var newValue = this.newValue || []; // tag不存在, 则添加, 存在则不处理
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      _this.originHandleOptionSelect = _this.$refs['select-tag'].handleOptionSelect;
      _this.$refs['select-tag'].handleOptionSelect = _this.handleOptionSelect;
    });
  }
});
...
var EleFormTag_component = normalizeComponent(
  ...
  EleFormTagvue_type_template_id_300f5cd1_render,
  EleFormTagvue_type_template_id_300f5cd1_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"de756198-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./lib/components/EleFormDaterange.vue?vue&type=template&id=70b0e2d9&
var EleFormDaterangevue_type_template_id_70b0e2d9_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-date-picker',_vm._g(_vm._b({staticClass:"ele-form-full-line",class:_vm.desc.class,style:(_vm.desc.style),on:{"input":_vm.handleChange},scopedSlots:_vm._u([_vm._l((_vm.desc.slots),function(render,key){return {key:key,fn:function(){return [_c('extend-slot',{key:key,attrs:{"render":render}})]},proxy:true}})],null,true),model:{value:(_vm.newValue),callback:function ($$v) {_vm.newValue=$$v},expression:"newValue"}},'el-date-picker',_vm.attrs,false),_vm.onEvents))}
var EleFormDaterangevue_type_template_id_70b0e2d9_staticRenderFns = []


// CONCATENATED MODULE: ./lib/components/EleFormDaterange.vue?vue&type=template&id=70b0e2d9&
...
var EleFormDaterange_component = normalizeComponent(
  ...
  EleFormDaterangevue_type_template_id_70b0e2d9_render,
  EleFormDaterangevue_type_template_id_70b0e2d9_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"de756198-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./lib/components/EleFormDatetimerange.vue?vue&type=template&id=0086f1ac&
var EleFormDatetimerangevue_type_template_id_0086f1ac_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-date-picker',_vm._g(_vm._b({staticClass:"ele-form-full-line",class:_vm.desc.class,style:(_vm.desc.style),on:{"input":_vm.handleChange},scopedSlots:_vm._u([_vm._l((_vm.desc.slots),function(render,key){return {key:key,fn:function(){return [_c('extend-slot',{key:key,attrs:{"render":render}})]},proxy:true}})],null,true),model:{value:(_vm.newValue),callback:function ($$v) {_vm.newValue=$$v},expression:"newValue"}},'el-date-picker',_vm.attrs,false),_vm.onEvents))}
var EleFormDatetimerangevue_type_template_id_0086f1ac_staticRenderFns = []


// CONCATENATED MODULE: ./lib/components/EleFormDatetimerange.vue?vue&type=template&id=0086f1ac&
...
var EleFormDatetimerange_component = normalizeComponent(
  ...
  EleFormDatetimerangevue_type_template_id_0086f1ac_render,
  EleFormDatetimerangevue_type_template_id_0086f1ac_staticRenderFns,
  false,
  null,
  null,
  null
...
var components = [EleForm, EleFormGroup, EleFormDialog, EleFormSection, EleFormTag, EleFormDate, EleFormRate, EleFormText, EleFormTime, EleFormWeek, EleFormYear, EleFormColor, EleFormDates, EleFormImage, EleFormInput, EleFormMonth, EleFormRadio, EleFormYesno, EleFormButton, EleFormNumber, EleFormSelect, EleFormSlider, EleFormSwitch, EleFormCascader, EleFormCheckbox, EleFormDatetime, EleFormPassword, EleFormTextarea, EleFormTransfer, EleFormDaterange, EleFormAutocomplete, EleFormCascaderPanel, EleFormDatetimerange, EleFormCheckboxButton];
var EleFormBuiltInNames = ['tag', 'date', 'rate', 'text', 'time', 'week', 'year', 'color', 'dates', 'image', 'input', 'month', 'radio', 'yesno', 'button', 'number', 'select', 'slider', 'switch', 'cascader', 'checkbox', 'datetime', 'password', 'textarea', 'transfer', 'daterange', 'autocomplete', 'cascader-panel', 'datetimerange', 'checkbox-button'];
