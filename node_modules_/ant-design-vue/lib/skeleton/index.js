...
var Skeleton = {
  ...
  render: function render() {
    ...
    if (loading || !(0, _propsUtil.hasProp)(this, 'loading')) {
      ...
      if (hasAvatar) {
        var avatarProps = {
          props: (0, _extends3['default'])({}, getAvatarBasicProps(hasTitle, hasParagraph), getComponentProps(avatar))
        };
      ...
      if (hasTitle || hasParagraph) {
        ...
        if (hasTitle) {
          var titleProps = {
            props: (0, _extends3['default'])({}, getTitleBasicProps(hasAvatar, hasParagraph), getComponentProps(title))
          };
        ...
        if (hasParagraph) {
          var paragraphProps = {
            props: (0, _extends3['default'])({}, getParagraphBasicProps(hasAvatar, hasTitle), getComponentProps(paragraph))
          };
