  ...
  <div class="version-detail">
                      ...
                      <div class="field-right">
                        ...
                        >
                          <a-tooltip placement="top">
                            <template slot="title">
                              <span v-if="disableEdit" style="font-size: 12px;"
                                >版本已发布，不能编辑</span
                              >
                            </template>
                            <span>
                          ...
                          <a-tooltip :mouseEnterDelay="0.5" v-if="!disableEdit">
                            ...
                            <div class="field-flex">
                              <a class="muted name" style="margin: 0;">
                                <template v-if="!version.setStartTime"
                                  >设置开始时间</template
                                >
                                <template v-else>{{
                      ...
                      <div class="field-right field-date">
                        ...
                        >
                          <a-tooltip :mouseEnterDelay="0.5" v-if="!disableEdit">
                            ...
                            <div class="field-flex">
                              <a class="muted name" style="margin: 0;">
                                <template v-if="!version.setPlanPublishTime"
                                  >设置发布时间</template
                                >
                                <template v-else>{{
    ...
    >
      <div>
        ...
        <p class="muted" v-show="!publishTask.selectTaskList.length">
          请勾选需要发布的内容
        </p>
      </div>
      <vue-scroll>
