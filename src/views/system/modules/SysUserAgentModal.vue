  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: `${window._CONFIG['domian']}/sys/sysUserAgent/add`,
          edit: `${window._CONFIG['domian']}/sys/sysUserAgent/edit`,
          queryByUserName:`${window._CONFIG['domian']}/sys/sysUserAgent/queryByUserName`,
        },
      }
    },
    created () {
