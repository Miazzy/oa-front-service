        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="cron表达式">
              <j-cron
                ref="innerVueCron"
                v-decorator="['cronExpression', {'initialValue':'0/1 * * * * ?'}]"
                @change="setCorn"
              ></j-cron>
...
export default {
  ...
  data() {
    return {
      ...
      departId:
        "4f1765520d6346f9bd9c79e2479e5b12,57197590443c44f083d42ae24ef26a2c",
      userRealName: "",
      multiUser: "",
      jcheckbox: {
...
sayHi('hello, world!')`
      ...
      jeditor: {
        value:
          '<h2 style="text-align: center;">富文本编辑器</h2> <p>这里是富文本编辑器。</p>'
      },
      jellipsis: {
        value:
